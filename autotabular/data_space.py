...
import gc
from autotabular.utils.log_utils import log, timeit
from autotabular.auto_tabular.utils.data_utils import ohe2cat
from autotabular.auto_tabular.utils.data_utils import fill_na
from autotabular.auto_tabular.utils.sample import AutoSample
from autotabular.auto_tabular import CONSTANT

class TabularDataSpace:
    def __init__(self, eda_info, main_df, y, lgb_info):
    ...
    def train_valid_split_idxs(self, ratio=0.2):
        ...
        i = 0
        for train, val in sss.split(idxs, self.y):
