...
class TabularModel:
    """TabularModel class"""
    def __init__(self, max_epoch, task, is_multi_label):
        self.X_train = None
        self.Y_train = None
        self.X_test = None
    ...
    def simple_lgb(self, X, y, test_x):
        ...
        if self.train_loop_num == 1:
            ...
            if self.is_multi_label:
                ...
                # binary classification and self.train_loop_num == 1 and sample_num <= 500
            ...
            if self.is_multi_label:
                ...
                # case self.train_loop_num > 1 and binary classification
